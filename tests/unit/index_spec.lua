...
describe("ensure_indexed — OpenAPI 3.0 YAML", function()
	...
	it("indexes all fixture files", function()
		...
		assert.is_true(indexed[spec30] or indexed[vim.fn.resolve(spec30)], "openapi30.yaml should be indexed")
		assert.is_true(indexed[user_yaml] or indexed[vim.fn.resolve(user_yaml)], "schemas/User.yaml should be indexed")
		assert.is_true(
			indexed[addr_yaml] or indexed[vim.fn.resolve(addr_yaml)],
